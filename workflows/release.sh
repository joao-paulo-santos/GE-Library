...
main() {
    ...
    if [ "$DRY_RUN" = true ]; then
        ...
        dry_run "  - linux-amd64 (ipf-extractor, ipf-optimizer)"
        dry_run "  - linux-arm64 (ipf-extractor, ipf-optimizer)"
        dry_run "  - windows-amd64 (ipf-extractor.exe, ipf-optimizer.exe)"
        dry_run "  - windows-arm64 (ipf-extractor.exe, ipf-optimizer.exe)"
        dry_run "  - darwin-amd64 (ipf-extractor, ipf-optimizer)"
        dry_run "  - darwin-arm64 (ipf-extractor, ipf-optimizer)"
        dry_run ""
